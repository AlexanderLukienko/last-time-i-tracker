document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!saveTaskButton || !eventNameInput || !reminderIntervalSelect || !taskListContainer) {
        console.error("❌ ERROR: One or more required elements are missing from the DOM!");
        return;
    }

    console.log("✅ Elements successfully loaded.");
    ...
    function checkReminders() {
        tasks.forEach((task, index) => {
            ...
            if (intervalsPassed > notifiedCount) {
                ...
                tasks[index].notifiedCount = intervalsPassed;
